...
#ifndef _ST_HPC_PPL_CV_X86_INFRASTRUCTURE_HPP_
#define _ST_HPC_PPL_CV_X86_INFRASTRUCTURE_HPP_
  ...
  for (int row = 0; row < rows; ++row) {
    ...
    for (int col = 0; col < cols; ++col) {
      if (basic_type == CV_8U) {
        ...
        if (channels == 4) {
          element[3] = (double) rand() / RAND_MAX;
        }
      }
      else {
      }
  ...
  for (int row = 0; row < rows; ++row) {
    ...
    for (int col = 0; col < cols; ++col) {
      if (basic_type == CV_8U) {
        ...
        if (channels == 4) {
          element[3] = clamp<T>(rand() % 256, begin, end);
        }
      }
      else if (basic_type == CV_8S) {
        ...
        if (channels == 4) {
          element[3] = clamp<T>(randomChar(), begin, end);
        }
      }
      else if (basic_type == CV_32F) {
        ...
        if (channels == 4) {
          element[3] = clamp<T>((float) rand() / RAND_MAX, begin, end);
        }
      }
      else if (basic_type == CV_64F) {
        ...
        if (channels == 4) {
          element[3] = clamp<T>((double) rand() / RAND_MAX, begin, end);
        }
      }
      else {
      }
...
#endif  // _ST_HPC_PPL_CV_X86_INFRASTRUCTURE_HPP_
